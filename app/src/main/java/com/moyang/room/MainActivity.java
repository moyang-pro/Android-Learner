...
import com.moyang.room.database.room.RoomLearnActivity;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button learnRoomBt = findViewById(R.id.bt_learn_room);
        learnRoomBt.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bt_learn_okhttp:
                ...
                break;
            case R.id.bt_learn_room:
                startMyActivity(RoomLearnActivity.class);
                break;
            default:
                break;
        }
